...
def register_smart_link_routes(app):
    ...
    # ===== ALSAAB_SMART_LINK_SALES_LOGIC_V2 START =====
    def _smart_sales_logic_for_message(message):
        ...
        if wants_income:
            return "\n".join([
                ...
                "في هذه الحالة لا تركز على منتجات صاحب المشروع، بل اشرح نظام الصعب مباشرة بطريقة بيعية محترمة.",
        ...
        if wants_human:
            return "\n".join([
                ...
                "جاوب بلطف، ووضح أنه يمكنه الرجوع إلى واتساب صاحب المشروع أو طلب رد بشري.",
    ...
    # ===== ALSAAB_SMART_LINK_SALES_LOGIC_V2 END =====
