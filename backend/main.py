...
def partner_dashboard_view():
    ...
    t = {
        "ar": {
            ...
            "share_mybot": "موظف المبيعات الذكي الخاص بمشروعك",
            "share_mybot_note": "يبيع منتجاتك أنت بأسعارك وصورك. أرسله لعملائك أنت — لا علاقة له بباقات الصعب ولا بالعمولة.",
            "share_chat": "رابط تسويق نظام الصعب",
            "share_chat_note": "يفتح بوت الصعب ليقنع من تريد ضمّه للنظام، وأي اشتراك منه يُحسب لك عمولة.",
        ...
        "en": {
            ...
            "share_mybot": "Your own sales assistant",
            "share_mybot_note": "Sells your products, at your prices, with your photos. Send it to your own customers — unrelated to ALSAAB packages or commission.",
            "share_chat": "ALSAAB referral link",
            "share_chat_note": "Opens the ALSAAB bot to convince someone to join, and any subscription through it earns you commission.",
